...
/////////////////////////////////////////////////////////////////////////////////////////
pub const MSVC_PATH: &str = env!("WRAPPER_MSVC_PATH");
pub const LLVM_PATH_VS: &str = env!("WRAPPER_LLVM_PATH_VS");
pub const LLVM_PATH: &str = env!("WRAPPER_LLVM_PATH");
pub const GCC_PATH: &str = env!("WRAPPER_GCC_PATH");
pub const WRAPPER_PATH: &str = env!("WRAPPER_WRAPPER_PATH");
...
pub static compilerKeywords: LazyLock<Regex> = LazyLock::new(||Regex::new(r#"(?i)(clang|cl|gcc|g\+\+)"#).unwrap());
...
pub const ResponseFileName: &str = "wrapper.rsp";
...
#[derive(Debug)]
pub enum EXEKind {
    COMPILER,    // compiler, e.g. clang, clang-cl, gcc, g++
